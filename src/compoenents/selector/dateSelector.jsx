    ...
    return (
      <div class="flex items-center justify-between mt-6">
        <div class="flex items-center">
          <div class="flex items-center">
            <div class="text-gray-700 p-2 hover:bg-gray-200 rounded-full border border-gray-500 cursor-pointer">
              <svg
                class="w-3 h-3 fill-current rotate"
            ...
            <div class="text-gray-700 p-2 ml-2 hover:bg-gray-200 rounded-full border border-gray-500 cursor-pointer">
